    ...
    return (
        ...
        <div className="row justify-content-center">
          <div className="col-md-6 border p-4 pb-5 rounded">
            ...
            <div>
              <label className="font-light font-14">Email address *</label>
              <div className="input-group mb-3">
                <input
                  type="email"
                  className="form-control"
            ...
            <div>
              <label className="font-light font-14">Phone*</label>
              <div className="input-group mb-3">
                  <span className="phone-number">+92</span>
                <input
                  type="number"
                  className="form-control flag"
                  aria-label="Default"
                  aria-describedby="inputGroup-sizing-default"
                  required
                />
