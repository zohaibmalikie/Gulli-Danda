...
import firstImage from "../assets/img/Screenshot_1.png";
import secondImage from "../assets/img/Screenshot_2.png";
import thirdImage from "../assets/img/Screenshot_3.png";
    ...
    <React.Fragment>
      ...
      <div className="background-image col-md-12 p-0 mt-5 m-0 row">
        ...
        <div className="m-0 pt-5 col-md-5 animation ">
         ...
         <ButtonCode className="btn bg-red-color font border-radius pl-4 pr-4 pt-2 pb-2 mb-5 mt-3 btn-animation"name="Enter now" FunctionName={(e)=>Alert(e)} />
        </div>
      </div>
...
<Step name="Step 3" source={thirdImage} label="Check out" id="border-none"/> 
<div className="col-md-4 m-auto text-center pt-4">
<ButtonCode className="btn bg-red-color font border-radius pl-5 pr-5 pt-1 pb-1 mb-5 mt-3"name="ENTER NOW" FunctionName={(e)=>Alert(e)} />
</div>
</div>
